...
public class Main {
    public static void main(String[] args) {
        ...
        while (!input.equals("System Split")) {
            ...
            switch (command) {
                case "RegisterPowerHardware", "RegisterHeavyHardware" -> system.hardwareRegistration(command, data);
                case "RegisterExpressSoftware", "RegisterLightSoftware" -> system.softwareRegistration(command, data);
                case "ReleaseSoftwareComponent" -> system.releaseSoftware(data);
